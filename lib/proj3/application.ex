defmodule Proj3.Application do
  ...
  #  Make routing table of all nodes
    ...
    # IO.inspect newNodehashName = Helper.hashFunction("node#{numNodes}")
    ...
    # IO.inspect Proj3.Route.route("F937", "6A18", newTable, 0)
    # max = 0
    # max = Enum.each(sourceDestinationMap, fn currentNode -> 
    ...
    #   max = Enum.each(destinationNodes, fn {_key, destinationNode} -> 
    ...
    #     max = Proj3.Tapestry.computeMaxHop(hops)
    #   end)
    # end)
